...
def add_questions():
    questions = [
        ('Сколько полос на флаге США?', '13', '20', '15', '12'),
        ('44 президент США', 'Обама', 'Трамп', 'Буш', 'Клинтон'),
        ('Сколько штатов в США?', '50', '44', '60', '55'),

        ('В какой из следующих иперий не было письменности:инков, ацтеков, египтян,римлян?', 'инков?', 'ацкетов', 'египтян', 'римлян'),
        ('В каком году Евросоюз ввел евро в качестве валюты?', '1999', '1989', '2000', '1980'),
        ('Какая валюта в Южной Африке?', 'ранд', 'найра', 'Крона', 'Бахат'),

        ('Какой элемент обозначается хим.символом Zr в таблице Менделеева?', 'Цирконий', 'Цинк', 'Стронцийй', 'Цезий'),
        ('Кто открыл пенецилин?', 'Александр Флеминг', 'Грегор Мендаль', 'Карл Линней', 'Чарьз Дарвин'),
        ('Из какого зера делаетяс японский спирь секе?', 'рис', 'гречка', 'овес', 'ячка')
